  ...
  context 'events from fixtures' do
    ...
    describe '.new red_card' do
      it 'not fails' do
        ...
        expect(visitor_red_card.event_match_id).to eq(fixture.match.match_id)
    ...
    describe '.new yellow_card' do
      it 'not fails' do
        ...
        expect(local_yellow_card.event_match_id).to eq(fixture.match.match_id)
    ...
    describe '.new local_goal' do
      it 'not fails' do
        ...
        expect(local_goal.event_match_id).to eq(fixture.match.match_id)
    ...
    describe '.new visitor_goal' do
      it 'not fails' do
        ...
        expect(away_goal.event_match_id).to eq(fixture.match.match_id)
